...
df <- read.csv("~/RStats/Anand-Carlsen/Data/Anand-Carlsen.csv", stringsAsFactors=F, strip.white=T)
df <- arrange(df, Game) #use plyr's arrange to Sort by Game Number

elo <- read.csv("~/RStats/Anand-Carlsen/Data/Anand_Carlsen_ELO.csv", stringsAsFactors=F, strip.white=T)
